...
#### 架构
JAVA_21 + springboot_3.2.0 + mybatis_3.5.14 + redis_7.0.9 + rabbitmq_3.11.10 + ELK_7.17.3 等,maven_3.9.5构建
...
46. 框架版本全面升级:JAVA_1.8 + springboot_2.7.5 + mybatis_3.4.6 + redis_7.0.9 + rabbitmq_3.11.10 + ELK_7.17.3 等,maven_3.8.4构建
    到 JAVA_20 + springboot_3.2.0 + mybatis_3.5.14 + redis_7.0.9 + rabbitmq_3.11.10 + ELK_7.17.3 等,maven_3.9.5构建
47. 排查整体结构中存在的问题并解决
