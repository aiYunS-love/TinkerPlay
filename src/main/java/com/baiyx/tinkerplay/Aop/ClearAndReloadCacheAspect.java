package com.baiyx.tinkerplay.Aop;

import com.baiyx.tinkerplay.CustomAnnotations.ClearAndReloadCache;
import com.baiyx.tinkerplay.Entity.QueryRequestVo;
import com.baiyx.tinkerplay.Entity.User;
import com.baiyx.tinkerplay.Utils.redisKeyUtil;
...
public class ClearAndReloadCacheAspect {
    ...
    @Pointcut("@annotation(com.baiyx.tinkerplay.CustomAnnotations.ClearAndReloadCache)")
    ...
    public Object aroundAdvice(ProceedingJoinPoint proceedingJoinPoint){
        ...
        for(int i=0;i<args.length;i++){
            if (args[i] instanceof com.baiyx.tinkerplay.Entity.User){
                User user = (User) args[i];
                name = redisKeyUtil.redisKey(name,user,args);
            }else if(args[i] instanceof com.baiyx.tinkerplay.Entity.QueryRequestVo){
